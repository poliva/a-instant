...
- **Multiple AI Providers**: Supports OpenAI, Anthropic, Google, DeepSeek, Mistral, xAI, Groq, Opencode Zen, OpenRouter, OllamaCloud, Custom OpenAI-compatible API providers and local models via Ollama and LMStudio
